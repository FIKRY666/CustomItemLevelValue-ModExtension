    ...
    public class ModBehaviour : Duckov.Modding.ModBehaviour
    {
        ...
        void OnEnable()
        {
            try
            {
                ...
                CustomItemLevelValue.Core.ModExtensionsManager.Instance.RegisterMod(MOD_PREFIX);
        ...
        private void IncreaseCounter()
        {
            ...
            try
            {
                CustomItemLevelValue.Core.ModExtensionsManager.Instance.RefreshItemCache(_currentItem, true);
